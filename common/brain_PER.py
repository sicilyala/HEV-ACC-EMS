import numpy as np
import torch
from common.maddpg_PER import MADDPG
...
class Brain:
    ...
    def learn(self, s0, a0, r0, s_0, s1, a1, r1, s_1, other_agents, ISWeights):
        td_error_up = self.policy.train(s0, a0, r0, s_0, s1, a1, r1, s_1, other_agents, ISWeights)
        return td_error_up
