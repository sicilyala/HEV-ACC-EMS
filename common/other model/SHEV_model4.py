...
class SHEV_model:
    def __init__(self):
        ...
        self.nominal_life = pow(20/self._severity_factor_fun(0.35, 2.5, 25), 1/0.57)
    ...
    @staticmethod
    def _severity_factor_fun(soc, I_c, T_batt):
        if soc >= 0.45:
            B = 2694.5*soc+6022.2
        else:
            B = 2896.6*soc+7411.2
    ...
    def run_battery(self, P_batt, SOC, SOH, Tep_c, Tep_s):
        # Battery efficiency
        ...
        # Ah_eff = severity_factor*abs(I_batt)  # TODO
        ...
        # sigma = self._severity_factor_fun(SOC_new, I_c, Tep_a)
        ...
        return SOC_new, SOH_new, Tep_c, Tep_s, Tep_a, life_depleted_fraction, I_batt, out_info
    ...
    def run_battery_cell(self, P_batt, paras_list):
        ...
        V1 = paras_list[6]
        V2 = paras_list[7]
        # battery pack of 10 cells
        P_cell = P_batt/10  # in W
